...
/**
 * An observable object can have one or more subscribers.
 */
export interface Observable {
     ...
     */
    subscribe(event: string, subscriber: Subscriber): Subscription;
}
 ...
 */
export interface Resource extends Observable, Closable {}
